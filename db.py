...
def init_db(conn: Connection):
	conn.execute(
		"""CREATE TABLE IF NOT EXISTS test
			(LATITUDE FLOAT,LONGITUDE FLOAT,LANDSLIDE_RISK INT,FLOOD_RISK INT,NAME TEXT,LANDSLIDE_RCLASS TEXT,FLOOD_RCLASS TEXT);"""
	)
	conn.commit()
...
if __name__ == "__main__":
	save(2.112,4,6,8,'name','ciao','ccsd')